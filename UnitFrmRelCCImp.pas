           ...
           calculosaldocc;
            ...
            if cbconta.Text<>'' then
               begin
                  ...
                  copy(MeDataFinal.text,7,4)+'/'+copy(MeDataFinal.text,4,2)+'/'+
                  copy(MeDataFinal.text,1,2)+chr(39)+')');
                  qrtitulo.Caption:='Relatório - Conta Corrente - '+
                  dm.contascorrenteconta.value+' - '+dm.contascorrentedescricao.value+
                  ' - Período: '+medatainicial.text+' à '+medatafinal.text;
                  qrtituloI.Caption:='Relatório - Conta Corrente - '+
                  dm.contascorrenteconta.value+' - '+dm.contascorrentedescricao.value+
                  ' - Período: '+medatainicial.text+' à '+medatafinal.text;
               end
               else
               begin
                  ...
                  copy(MeDataFinal.text,7,4)+'/'+copy(MeDataFinal.text,4,2)+'/'+
                  copy(MeDataFinal.text,1,2)+chr(39)+')');
                  qrtitulo.Caption:='Relatório - Contas Corrente'+
                  ' - Período: '+medatainicial.text+' à '+medatafinal.text;
                  qrtituloI.Caption:='Relatório - Contas Corrente'+
                  ' - Período: '+medatainicial.text+' à '+medatafinal.text;
               end;
