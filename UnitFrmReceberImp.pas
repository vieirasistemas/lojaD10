...
begin
      ...
      if rb2.Checked then
         begin
           qrtitulo.Caption:='Relatório Documentos à Receber - à Vencer';
           RLReport2.preview;
         end
      else if rb5.Checked then
         begin
           qrtitulo.Caption:='Relatório Documentos à Receber - em Aberto';
           RLReport2.preview;
         end
      else if rb1.Checked then
         begin
           qrtitulo.Caption:='Relatório Documentos à Receber - Vencidos';
           RLReport2.preview;
         end
         else
         begin
           qrtituloI.Caption:='Relatório Documentos à Receber';
           RLReport1.preview;
         end;
end;
