...
//    FrmPagar.cbtipo.text:=dm.docpagartipo.Value;
    ...
    if dm.docpagarpagtoem.Value='0' then
       ...
       FrmPagar.cbpagtoem.Text:='5-CARTÃO CRÉDITO'
    else if dm.docpagarpagtoem.Value='6' then
       FrmPagar.cbpagtoem.Text:='6-CARTÃO DÉBITO'
    else if dm.docpagarpagtoem.Value='7' then
       FrmPagar.cbpagtoem.Text:='7-DÉBITO AUTOMÁTICO'
    else
...
begin
      if (meemissao.Text='  /  /    ') or
         ...
         (edvalor.Text='') then
         begin
           application.MessageBox('É obrigatório preencher: FORNECEDOR, EMISSÃO, VENCIMENTO E VALOR','Atenção',mb_Ok+mb_iconerror);
           edfornecedor.SetFocus;
         end
         else
         begin
          if opcao=1 then
             begin
               try
                ...
                application.MessageBox('Erro ao Inserir o Registro','Atenção',mb_Ok+mb_iconerror);
                btcancelar.Click;
               end;
             end
  ...
  if Key = 13 then
     ...
     begin
       ...
       if dm.usuarioscontaspagar.Value='5' then
          begin
           if Application.Messagebox ('Confirma Operação?','Autorização de Pagamento', Mb_YesNo+mb_iconquestion) = id_yes then
              begin
           ...
           application.MessageBox('Contate o Administrador','Operação não Autorizada',mb_Ok+MB_ICONINFORMATION);
     end;
end;
...
{        if cbempresa.Text<>'' then
           begin
             ...
             if not dm.Empresas.Locate('nome',cbempresa.Text,[]) then
                begin
                  application.MessageBox('Empresa não Cadastrada','Atenção',mb_ok+mb_iconinformation);
                  cbempresa.SetFocus;
                end;
           end;
}end;
  ...
  if rb2.Checked then
     begin
       if edccger.Text='' then
          ...
          qrtitulo.Caption:='Relatório Documentos à Pagar - à Vencer da Empresa: '+lbccger.Caption;
     end
     ...
     begin
       if edccger.Text='' then
          ...
          qrtitulo.Caption:='Relatório Documentos à Pagar - Vencidos da Empresa: '+lbccger.Caption;
     end
  else
  begin
     if edccger.Text='' then
        ...
        qrtitulo.Caption:='Relatório Documentos à Pagar da Empresa: '+lbccger.Caption;
  end;
  if mefinal.Text<>'  /  /    ' then
     begin
       if edccger.Text='' then
          ...
          qrtituloI.Caption:='Documentos Pagos em '+meinicial.Text+' à '+mefinal.Text+' - Empresa: '+lbccger.Caption;
       RLReport2.preview;
     end
     else
       RLReport1.preview;
...
begin
        ...
        if rb1.Checked then
           begin
             ...
             //Vencidos por Emissão e Vencimento e Fornecedor
             else if (MeDataFinal.text<>'  /  /    ') and
                (medtfinal.text<>'  /  /    ') and
                (mefinal.text='  /  /    ') and
                (lbfornecedorI.caption<>'') and
             ...
             //Vencidos por Emissão e Fornecedor
             else if (MeDataFinal.text<>'  /  /    ') and
                (medtfinal.text='  /  /    ') and
                (mefinal.text='  /  /    ') and
                (lbfornecedorI.caption<>'') and
             ...
             //Vencidos por Período e fornecedor
             else if (MeDataFinal.text='  /  /    ') and
                (mefinal.text='  /  /    ') and
                (medtfinal.text<>'  /  /    ') and
                (lbfornecedorI.caption<>'') and
        ...
        //Consulta por Doc. à Vencer
           ...
           begin
             ...
             //à Vencer por Emissão e Vencimento
             else if (MeDataFinal.text<>'  /  /    ') and
                (medtfinal.text<>'  /  /    ') and
                (mefinal.text='  /  /    ') and
                (lbfornecedorI.caption='') and
             ...
             //à Vencer por Emissão e Vencimento e Fornecedor
             else if (MeDataFinal.text<>'  /  /    ') and
                (medtfinal.text<>'  /  /    ') and
                (mefinal.text='  /  /    ') and
                (lbfornecedorI.caption<>'') and
             ...
             //à Vencer por Emissão e Vencimento e Tipo
             else if (MeDataFinal.text<>'  /  /    ') and
                (medtfinal.text<>'  /  /    ') and
                (mefinal.text='  /  /    ') and
                (lbfornecedorI.caption='') and
             ...
             //à Vencer por Emissão por Fornecedor
             else if (MeDataFinal.text<>'  /  /    ') and
                (medtfinal.text='  /  /    ') and
                (mefinal.text='  /  /    ') and
                (lbfornecedorI.caption<>'') and
             ...
             //à Vencer por Vencimento e fornecedor
             else if (MeDataFinal.text='  /  /    ') and
                (mefinal.text='  /  /    ') and
                (medtfinal.text<>'  /  /    ') and
                (lbfornecedorI.caption<>'') and
             ...
             //à Vencer por Vencimento e Tipo
             else if (MeDataFinal.text='  /  /    ') and
                (mefinal.text='  /  /    ') and
                (medtfinal.text<>'  /  /    ') and
                (lbfornecedorI.caption='') and
...
begin
  ...
  if dm.docpagarpagtoem.Value='0' then
     ...
     qrpagamentoem.Caption:='PAGAMENTO PELO CARTÃO CRÉDITO'
  else if dm.docpagarpagtoem.Value='6' then
     qrpagamentoem.Caption:='PAGAMENTO PELO CARTÃO DÉBITO'
  else if dm.docpagarpagtoem.Value='7' then
     qrpagamentoem.Caption:='DÉBITO AUTOMÁTICO'
  else
     qrpagamentoem.Caption:='';

//  qrdatapgto.caption:='São Luís, '+DataExtenso(dm.docpagarpgto.value);
...
begin
  if mefinal.Text<>'' then
     begin
       ...
       begin
         Application.MessageBox('Preencha o Período do Pagamento e clique em Consultar','Atenção',mb_ok+MB_ICONERROR);
         medtfinal.SetFocus;
       end;
     end
     else
     begin
       Application.MessageBox('Preencha o Período do Pagamento','Atenção',mb_ok+MB_ICONINFORMATION);
       medtfinal.SetFocus;
     end;
end;
  ...
  if edccger.Text<>'' then
     begin
        ...
        if not dm.planocontas.Locate('codigo',edccger.Text,[]) then
           begin
             application.MessageBox('Conta não Localizada','Atenção',mb_ok+mb_iconinformation);
             edccger.SetFocus;
           end
           else
