object FrmEstoqueRel: TFrmEstoqueRel
  Left = 462
  Top = 167
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Movimenta'#231#227'o Estoque - Sint'#233'tico'
  ClientHeight = 398
  ClientWidth = 378
  Color = clBtnFace
  ...
  object Label8: TLabel
    ...
    Height = 16
    AutoSize = False
    Caption = 'F10 Cliente/Fornecedor'
    Font.Charset = ANSI_CHARSET
    Font.Color = clBlue
    Font.Height = -11
    Font.Name = 'Arial'
  ...
  object edproduto: TEdit
    ...
    Width = 81
    Height = 21
    Hint = 'Pressione F11 para consultar o produto'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clBlack
    Font.Height = -11
    Font.Name = 'MS Sans Serif'
  ...
  object chquebrar: TCheckBox
    ...
    Width = 233
    Height = 17
    Caption = 'Quebrar por Tipo de Movimento'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clRed
    Font.Height = -11
    Font.Name = 'MS Sans Serif'
  ...
  object QuickRep4: TQuickRep
    ...
    object QRGroup1: TQRGroup
      ...
      Expression = 'qrMovEstoque.TipoMov'
      FooterBand = QRBand11
      Master = QuickRep4
    ...
    object QRBand11: TQRBand
      ...
      object QRExpr10: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(qrMovEstoque.qtd)'
        FontSize = 8
      end
    end
  ...
  object Query1: TZQuery
    ...
    SQL.Strings = (
        ...
        'select E.produto,P.nome as nomeproduto,E.und,sum(E.qtd) as qtd,s' +
        'um(E.vlrtotal) as Total,F.nome'
      'from movestoque E, produtos P, fornecedores F'
      
        'where (E.data='#39'2012/12/26'#39') and (E.produto=P.codigo) and (E.favo' +
        'recido=F.codigo)'
      'group by P.nome'
      'order by F.nome,P.nome')
    Params = <>
    object Query1produto: TIntegerField
      FieldName = 'produto'
      Required = True
    end
    object Query1nomeproduto: TStringField
      FieldName = 'nomeproduto'
      Required = True
      Size = 50
    end
    object Query1und: TStringField
      FieldName = 'und'
      Required = True
      Size = 5
    end
