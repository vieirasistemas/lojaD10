object FrmNotasFiscais: TFrmNotasFiscais
  ...
  Caption = 'Comercial - Notas Fiscais'
  ClientHeight = 573
  ClientWidth = 797
  Color = clBtnFace
    ...
    object TabSheet1: TTabSheet
      ...
      object gbnf: TGroupBox
        ...
        object merecepcao: TMaskEdit
          ...
          TabOrder = 4
          Text = '  /  /    '
          OnEnter = merecepcaoEnter
          OnExit = merecepcaoExit
          OnKeyDown = CbEmpresaKeyDown
        end
        object edvlrcontabil: TEditAlinh
          Left = 470
          Top = 72
          Width = 96
          Height = 21
          ...
          ParentFont = False
          TabOrder = 7
          OnExit = edvlrcontabilExit
          OnKeyDown = CbEmpresaKeyDown
          Alinhamento = taRightJustify
        end
        object edbasecalculo: TEditAlinh
          Left = 575
          Top = 72
          Width = 96
          Height = 21
          ...
          ParentFont = False
          TabOrder = 8
          OnExit = edbasecalculoExit
          OnKeyDown = CbEmpresaKeyDown
          Alinhamento = taRightJustify
        end
        object edicms: TEditAlinh
          Left = 8
          Top = 112
          Width = 113
          Height = 21
        ...
        object edvlrisentas: TEditAlinh
          Left = 360
          Top = 112
          Width = 92
          Height = 21
          ...
          ParentFont = False
          TabOrder = 13
          OnExit = edvlrisentasExit
          OnKeyDown = CbEmpresaKeyDown
          Alinhamento = taRightJustify
        end
        object edvlroutras: TEditAlinh
          Left = 470
          Top = 112
          Width = 96
          Height = 21
          ...
          ParentFont = False
          TabOrder = 14
          OnExit = edvlroutrasExit
          OnKeyDown = CbEmpresaKeyDown
          Alinhamento = taRightJustify
        end
        object edbasesubst: TEditAlinh
          Left = 575
          Top = 112
          Width = 96
          Height = 21
          ...
          ParentFont = False
          TabOrder = 15
          OnExit = edbasesubstExit
          OnKeyDown = CbEmpresaKeyDown
          Alinhamento = taRightJustify
        end
        object edicmssubst: TEditAlinh
          Left = 679
          Top = 112
          Width = 96
          Height = 21
        ...
        object StatusBar3: TStatusBar
          ...
          Panels = <
            item
              Text = 'ESC para cancelar a Movimenta'#231#227'o'
              Width = 200
            end
            item
              Text = 'F4 cancelar Nota Fiscal'
              Width = 150
            end
            item
              Text = 'F11 consultar Chave NFE'
              Width = 200
            end
            item
              Text = 'F12 concluir a movimenta'#231#227'o'
              Width = 50
            end>
        end
      end
      ...
      object DBGrid1: TDBGrid
        ...
        Width = 780
        Height = 297
        Hint = 'D'#234' um duplo clique para passar atualizar a janela'
      ...
      object QuickRep1: TQuickRep
        ...
        object QRBand1: TQRBand
          ...
          object qr6: TQRExpr
            ...
            Transparent = False
            WordWrap = True
            Expression = 'qrMovEstoque.VlrUnit'
            Mask = '#,##0.00'
            FontSize = 8
          end
        ...
        object SummaryBand1: TQRBand
          ...
          object QRExpr18: TQRExpr
            ...
            Transparent = False
            WordWrap = True
            Expression = 'SUM(qrMovEstoque.VlrTotal)'
            Mask = '#,##0.00'
            FontSize = 8
          end
        end
    ...
    object TabSheet2: TTabSheet
      ...
      object gbmovestoque: TGroupBox
        ...
        object cbunidade: TComboBox
          ...
          OnKeyDown = cbtipomovimentoKeyDown
        end
        ...
        object StatusBar1: TStatusBar
          ...
          Panels = <
            ...
            item
              Text = 'F11 para consultar um produto'
              Width = 200
            end
            item
              Text = 'F12 para concluir a movimenta'#231#227'o'
              Width = 200
            end>
        end
    ...
    object TabSheet3: TTabSheet
      ...
      object gbdocpagar: TGroupBox
        ...
        object mevencto: TMaskEdit
          ...
          Text = '  /  /    '
          OnExit = mevenctoExit
          OnKeyDown = cbtipodocKeyDown
        end
        object eddocum: TEdit
          Left = 304
          Top = 32
          Width = 113
          Height = 21
        ...
        object edvalordoc: TEditAlinh
          ...
          ParentFont = False
          TabOrder = 6
          OnExit = edvalordocExit
          OnKeyDown = cbtipodocKeyDown
          Alinhamento = taRightJustify
        end
        object edlocalcob: TEdit
          Left = 8
          Top = 72
          Width = 281
          Height = 21
        ...
        object StatusBar2: TStatusBar
          ...
          Panels = <
            item
              Text = 'Pressione ESC para cancelar a Movimenta'#231#227'o'
              Width = 230
            end
            item
              Text = 'Pressione F12 para concluir a movimenta'#231#227'o'
              Width = 50
            end>
        end
        ...
        object meemissaodoc: TMaskEdit
          ...
          TabOrder = 2
          Text = '  /  /    '
          OnExit = meemissaodocExit
          OnKeyDown = cbtipodocKeyDown
        end
        object cbplconta: TComboBox
          Left = 304
          Top = 72
          Width = 321
          Height = 21
  ...
  object qrconsulta: TZQuery
    ...
    SQL.Strings = (
      'select N.documento,N.favorecido,N.tipo,N.emissao,N.recepcao,'
      'N.vlrcontabil,N.basecalculo,C.nome,N.cancelada'
      'from NF N, clientes C'
      'where N.favorecido=C.codigo')
    Params = <>
    Left = 431
    Top = 1
    object qrconsultadocumento: TStringField
      FieldName = 'documento'
      Required = True
      Size = 15
    end
    object qrconsultafavorecido: TIntegerField
      FieldName = 'favorecido'
      Required = True
    end
    object qrconsultatipo: TStringField
      FieldName = 'tipo'
      Required = True
      Size = 1
    end
    ...
    object qrconsultarecepcao: TDateField
      FieldName = 'recepcao'
      Required = True
    end
    object qrconsultavlrcontabil: TFloatField
      FieldName = 'vlrcontabil'
      DisplayFormat = '#,##0.00'
    end
    object qrconsultabasecalculo: TFloatField
      FieldName = 'basecalculo'
      DisplayFormat = '#,##0.00'
    end
    ...
    object qrconsultacancelada: TStringField
      FieldName = 'cancelada'
      Size = 1
    end
  end
  object qrMovEstoque: TZQuery
    ...
    SQL.Strings = (
      ...
      'E.und,E.qtd,E.VlrUnit,E.VlrTotal,P.nome,E.lote'
    ...
    object qrMovEstoquelote: TStringField
      FieldName = 'lote'
      Required = True
      Size = 15
    end
  ...
  object qrtotalizar: TZQuery
    ...
    SQL.Strings = (
        ...
        'select count(*) as N_qtd, sum(vlrtotal) as TotalGeral from MovEs' +
        'toque')
    Params = <>
    Left = 592
    object qrtotalizarN_qtd: TLargeintField
      FieldName = 'N_qtd'
      Required = True
    end
    object qrtotalizarTotalGeral: TFloatField
