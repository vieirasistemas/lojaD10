...
begin
  if edcliente.text='' then
     ...
     begin
        if Application.Messagebox ('Deseja excluir o registro?','Atenção', Mb_YesNo+mb_iconquestion) = id_yes then
           begin
              busca := '';
  ...
  if cbtipo.Text<>'' then
     begin
       ...
       if not dm.formapagto.Locate('codigo',copy(cbtipo.Text,1,2),[]) then
          begin
            application.MessageBox('Forma Pagamento Inválida','Atenção',mb_ok+mb_iconinformation);
            cbtipo.SetFocus;
          end
          else
          begin
...
begin
        ...
        Try
           ...
           If StrToDate(meemissao.Text) > StrToDate(mevencto.Text) then
              Begin
                 MessageBox(Handle, 'Data de Vencimento inferior à Data de Emissão!!', 'Atenção', mb_IconWarning or mb_Ok);
                 mevencto.SetFocus;
              End;
        Except
        begin
...
begin
      if (mevencto.Text='  /  /    ') and (edvalor.Text='') then
         begin
           application.MessageBox('Preenchimento do Vencimento e Valor Obrigatório','Atenção',mb_Ok+mb_iconerror);
           edcliente.SetFocus;
         end
         else
         begin
...
begin
        ...
        if rb1.Checked then
           begin
             ...
             //Vencidos por Emissão e Vencimento
             else if (MeDataFinal.text<>'  /  /    ') and
                (medtfinal.text<>'  /  /    ') and
                (mefinal.text='  /  /    ') and
                (lbclienteI.caption='') and
             ...
             //Vencidos por Emissão e Vencimento e cliente
             else if (MeDataFinal.text<>'  /  /    ') and
                (medtfinal.text<>'  /  /    ') and
                (mefinal.text='  /  /    ') and
                (lbclienteI.caption<>'') and
             ...
             //Vencidos por Emissão e Vencimento e Tipo
             else if (MeDataFinal.text<>'  /  /    ') and
                (medtfinal.text<>'  /  /    ') and
                (mefinal.text='  /  /    ') and
                (lbclienteI.caption='') and
        ...
        //Consulta por Doc. à Vencer
           ...
           begin
             ...
             //à Vencer por Período de Vencimento
             else if (MeDataFinal.text='  /  /    ') and
                (medtfinal.text<>'  /  /    ') and
                (mefinal.text='  /  /    ') and
                (lbclienteI.caption='') and
             ...
             //à Vencer por Período de Emissão
             else if (MeDataFinal.text<>'  /  /    ') and
                (medtfinal.text='  /  /    ') and
                (mefinal.text='  /  /    ') and
                (lbclienteI.caption='') and
             ...
             //à Vencer por Período de Emissão e Vencimento
             else if (MeDataFinal.text<>'  /  /    ') and
                (medtfinal.text<>'  /  /    ') and
                (mefinal.text='  /  /    ') and
                (lbclienteI.caption='') and
             ...
             //à Vencer por Período de Emissão e Vencimento e Cliente
             else if (MeDataFinal.text<>'  /  /    ') and
                (medtfinal.text<>'  /  /    ') and
                (mefinal.text='  /  /    ') and
                (lbclienteI.caption<>'') and
             ...
             //à Vencer por Período de Emissão e Vencimento e Tipo
             else if (MeDataFinal.text<>'  /  /    ') and
                (medtfinal.text<>'  /  /    ') and
                (mefinal.text='  /  /    ') and
                (lbclienteI.caption='') and
             ...
             //à Vencer por Perído de Vencimento e Cliente
             else if (MeDataFinal.text='  /  /    ') and
                (mefinal.text='  /  /    ') and
                (medtfinal.text<>'  /  /    ') and
                (lbclienteI.caption<>'') and
             ...
             //à Vencer por Perído de Emissão e Cliente
             else if (MeDataFinal.text<>'  /  /    ') and
                (mefinal.text='  /  /    ') and
                (medtfinal.text='  /  /    ') and
                (lbclienteI.caption<>'') and
             ...
             //à Vencer por Perído de Vencimento e Tipo
             else if (MeDataFinal.text='  /  /    ') and
                (mefinal.text='  /  /    ') and
                (medtfinal.text<>'  /  /    ') and
                (lbclienteI.caption='') and
        ...
        //Consulta por Doc. Pagos
           ...
           begin
             ...
             //Pagos por Período de Vencimento
             else if (MeDataFinal.text='  /  /    ') and
                (medtfinal.text<>'  /  /    ') and
                (mefinal.text='  /  /    ') and
                (lbclienteI.caption='') and
             ...
             //Pagos por Período de Emissão e Vencimento
             else if (MeDataFinal.text<>'  /  /    ') and
                (medtfinal.text<>'  /  /    ') and
                (mefinal.text='  /  /    ') and
                (lbclienteI.caption='') and
             ...
             //Pagos por Período de Emissão e Vencimento e Cliente
             else if (MeDataFinal.text<>'  /  /    ') and
                (medtfinal.text<>'  /  /    ') and
                (mefinal.text='  /  /    ') and
                (lbclienteI.caption<>'') and
             ...
             //Pagos por Período de Emissão e Vencimento e Tipo
             else if (MeDataFinal.text<>'  /  /    ') and
                (medtfinal.text<>'  /  /    ') and
                (mefinal.text='  /  /    ') and
                (lbclienteI.caption='') and
             ...
             //Pagos por Perído de Vencimento e Cliente
             else if (MeDataFinal.text='  /  /    ') and
                (mefinal.text='  /  /    ') and
                (medtfinal.text<>'  /  /    ') and
                (lbclienteI.caption<>'') and
             ...
             //PAgos por Perído de Emissão e Cliente
             else if (MeDataFinal.text<>'  /  /    ') and
                (mefinal.text='  /  /    ') and
                (medtfinal.text='  /  /    ') and
                (lbclienteI.caption<>'') and
             ...
             //Pagos por Perído de Vencimento e Tipo
             else if (MeDataFinal.text='  /  /    ') and
                (mefinal.text='  /  /    ') and
                (medtfinal.text<>'  /  /    ') and
                (lbclienteI.caption='') and
        ...
        //Consulta por Doc. Em Aberto
           ...
           begin
             ...
             //Em aberto por período de vencimento
             else if (MeDataFinal.text='  /  /    ') and
                (medtfinal.text<>'  /  /    ') and
                (mefinal.text='  /  /    ') and
                (edclienteI.Text='') and
             ...
             //Em aberto por período de emissão
             else if (MeDataFinal.text<>'  /  /    ') and
                (medtfinal.text='  /  /    ') and
                (mefinal.text='  /  /    ') and
                (edclienteI.Text='') and
             ...
             //Em aberto por período de vencimento e cliente
             else if (MeDataFinal.text='  /  /    ') and
                (medtfinal.text<>'  /  /    ') and
                (mefinal.text='  /  /    ') and
                (edclienteI.Text<>'') and
             ...
             //Em aberto por período de emissão e vencimento
             else if (MeDataFinal.text<>'  /  /    ') and
                (medtfinal.text<>'  /  /    ') and
                (mefinal.text='  /  /    ') and
                (edclienteI.Text='') and
             ...
             //Em aberto por período de emissão e vencimento e Cliente
             else if (MeDataFinal.text<>'  /  /    ') and
                (medtfinal.text<>'  /  /    ') and
                (mefinal.text='  /  /    ') and
                (edclienteI.Text<>'') and
             ...
             //Em aberto por período de emissão e vencimento e Tipo
             else if (MeDataFinal.text<>'  /  /    ') and
                (medtfinal.text<>'  /  /    ') and
                (mefinal.text='  /  /    ') and
                (edclienteI.Text='') and
             ...
             //Em aberto por período de emissão e cliente
             else if (MeDataFinal.text<>'  /  /    ') and
                (medtfinal.text='  /  /    ') and
                (mefinal.text='  /  /    ') and
                (edclienteI.Text<>'') and
             ...
             //Em aberto por período de vencimento e tipo
             else if (MeDataFinal.text='  /  /    ') and
                (medtfinal.text<>'  /  /    ') and
                (mefinal.text='  /  /    ') and
                (edclienteI.Text='') and
...
{             if cbconta.Text='' then
           ...
           begin
             ...
             if dm.usuarioscontasreceber.value='5' then
                begin
                   if Application.Messagebox ('Deseja cancelar baixa?','Título Já Baixado', Mb_YesNo+mb_iconquestion) = id_yes then
                      begin
                         busca := '';
                  ...
                  application.MessageBox('Contate o Atenção para cancelar baixa','Título Já Baixado',mb_ok+MB_ICONERROR);
           end;
     end;
end;
           ...
           if dm.usuarioscontasreceber.Value<>'5' then
              begin
                if StrToDate(mepagto.Text)<>date then
                   begin
                     application.MessageBox('Data de Pagamento Inferior a Data Atual!','Atenção',mb_Ok+mb_iconerror);
                     mepagto.setfocus;
                   end;
              end
              else
...
begin
      ...
      if (cbconta.Text<>'') and (cbplanoconta.Text<>'') and
               ...
               begin
                  if opcao=3 then
                     begin
                       ...
                       if StringToFloat(edvalorpago.text)<StringToFloat(edliquido.text) then
                          begin
                            if Application.Messagebox ('Confirma Lançamento?','Pagamento por Conta', Mb_YesNo+mb_iconquestion) = id_yes then
                               begin
                                  Try
                                    dm.docreceber.Close;
                                    dm.docreceber.SQL.Clear;
         ...
         begin
           application.MessageBox('Preencha: Conta Corrente, Pl. Contas, Data Pgto e Valor Pago','Atenção',mb_Ok+mb_iconerror);
           limparbaixa;
           P_Baixar.Enabled:=false;
           btconfirmar.Enabled:=false;
           btbaixar.Enabled:=true;
...
begin
  if chExcel.Checked=false then
     begin
      ...
      if rb2.Checked then
         begin
           FrmReceberImp.qrtitulo.Caption:='Relatório Documentos à Receber - à Vencer';
           FrmReceberImp.qrtituloII.Caption:='Relatório Documentos à Receber - à Vencer';
         ...
         begin
           FrmReceberImp.qrtitulo.Caption:='Relatório Documentos à Receber - em Aberto';
           FrmReceberImp.qrtituloII.Caption:='Relatório Documentos à Receber - em Aberto';
           if chquebrar.Checked=false then
              FrmReceberImp.RLReport2.preview
           else
              FrmReceberImp.QuickRep1.preview
         ...
         begin
           FrmReceberImp.qrtitulo.Caption:='Relatório Documentos à Receber - Vencidos';
           FrmReceberImp.qrtituloII.Caption:='Relatório Documentos à Receber - Vencidos';
           if chquebrar.Checked=false then
              FrmReceberImp.RLReport2.preview
           else
              FrmReceberImp.QuickRep1.preview
         ...
         begin
           FrmReceberImp.qrtituloI.Caption:='Relatório Documentos à Receber';
           FrmReceberImp.qrtituloII.Caption:='Relatório Documentos à Receber';
           if chquebrar.Checked=false then
     ...
     begin
      ...
      if rb2.Checked then
         Excel.WorkBooks[1].Sheets[1].Cells[1,1]:='Relatório Documentos à Receber - à Vencer'
      else if rb5.Checked then
         Excel.WorkBooks[1].Sheets[1].Cells[1,1]:='Relatório Documentos à Receber - em Aberto'
      else if rb1.Checked then
         Excel.WorkBooks[1].Sheets[1].Cells[1,1]:='Relatório Documentos à Receber - Vencidos'
      else
         Excel.WorkBooks[1].Sheets[1].Cells[1,1]:='Relatório Documentos à Receber';
      ...
      Excel.WorkBooks[1].Sheets[1].Cells[3,4]:='Emissão';
...
begin
       ...
       if (mevenctoinicial.text<>'  /  /    ') and
          ...
          begin
            ...
            series1.Add(vencer, 'Total à Receber', clred ) ;

            With Chart1.Title.Text do
            begin
              Clear;
              Add('Gráfico - Documentos à Receber no Périodo de : '+
              mevenctoinicial.text+' à '+mevenctofinal.text);
            end;
            Chart1.Repaint;
          end;
end;
       ...
       try
         ...
         if edliquido.Text<>'' then
            begin
              ...
              FrmRecibo.Memo1.Text:='Quitação do documento '+EdDocumento.Text;
            end;
         FrmRecibo.showmodal;
       finally
         FrmRecibo.Release;
...
begin
      if eddoc.text<>'' then
         begin
           ...
           qrrodape.Lines.Add('Reconheço(emos) a exatidão desta DUPLICATA DE VENDA MERCANTIL E/OU PRESTAÇÃO DE SERVIÇOS, na importância acima que pagarei(emos) à '+dm.parametrosrazaosocial.Value+', ou à sua Ordem na praça e vencimento acima indicados.');
           QuickRep2.Preview;
         end;
end;
       ...
       if opcao=1 then
          begin
            ...
            if dm.docreceber.RecordCount>0 then
               begin
                 showmessage('Documento já Lançado');
      ...
      if opcao=1 then
        begin
          if (edbanco.Text<>'') and (edagencia.Text<>'') and (EdCC.Text<>'') and (Edcheque.Text<>'') then
             ...
             begin
               application.MessageBox('Preencha o Banco, Agência, Conta Corrente e Nº Cheque!','Atenção',mb_Ok+mb_iconerror);
               edbanco.setfocus;
             end;
        end;
     end;
